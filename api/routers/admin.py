...
<p>Events: {esc(str(s.get('events', 0)))} &middot; Unique IPs: {esc(str(s.get('unique_ips', 0)))} &middot; New IPs: {esc(str(s.get('new_ips', 0)))} &middot; Scans: {esc(str(s.get('scans', 0)))} &middot; IPs blocked: {esc(str(s.get('blocked_ips', 0)))}</p>
